...
export default function InvoiceAddData({
  handleData = null,
  rowData,
  id,
  action,
      ...
      <tr>
        <td>
          ...
          >
                  ...
                  return (
                    ...
                    >
                      <p className="tw-text-xs tw-font-normal tw-not-italic tw-leading-[18px] tw-text-text-medium-gray">
                        ...
                        {invoice.comment && invoice.comment.createdByName}
                      </p>
                      <p className="tw-text-xs tw-font-normal tw-not-italic tw-leading-[18px] tw-text-text-medium-gray">
                        <span className="tw-text-xs tw-font-medium tw-not-italic tw-leading-[18px] tw-text-text-black">
                          {' '}
                        ...
                        {formatDate(invoice.comment && invoice.comment.updatedAt) ||
                          formatDate(invoice.comment && invoice.comment.createdAt)}
                      </p>
                      <p className="tw-text-xs tw-font-normal tw-not-italic tw-leading-[18px] tw-text-text-medium-gray">
                        {invoice.comment && invoice.comment.comment}
                      </p>
                    </div>
                  );
                })}
            ...
            >
              <FileInput module={rowData} moduleName="INVOICE" />
            </div>
            <div
              className={` ${
                rowData.status.toLowerCase() === 'rejected'
                      ...
                      <>
                        ...
                        invoice.currentStatus !== 'DRAFT' ? (
                          <p className="tw-mt-2 tw-text-xs tw-font-medium tw-not-italic tw-leading-[18px] tw-text-text-black">
                            ...
                            <span className="tw-mr-[1px] tw-text-text-medium-gray">
                              {invoice && invoice.currentStatus
                                ? capitalizeFirstLetter(invoice.currentStatus)
                                : ''}
                            </span>{' '}
                            to{' '}
                            <span className="tw-mr-[1px] tw-text-text-medium-gray">
                              {invoice && invoice.previousStatus
                                ? capitalizeFirstLetter(invoice.previousStatus)
                                : ''}
                            </span>
                            <br />
                            Status change by:{' '}
                            <span className="tw-mr-[1px] tw-text-text-medium-gray">
                              {invoice && invoice.createdByName
                                ? capitalizeFirstLetter(invoice.createdByName)
                                : ''}
                            </span>{' '}
                            <br />
                            Status change at:{' '}
                        ...
                        {invoice?.convertedFrom && (
                          <p className="tw-mt-2 tw-text-xs tw-font-medium tw-not-italic tw-leading-[18px] tw-text-text-black">
                            Converted From:{' '}
                            <span className="tw-mr-[1px] tw-text-text-medium-gray">
                              {invoice && invoice.convertedFrom
                                ? capitalizeFirstLetter(invoice.convertedFrom)
                                : ''}
                            </span>{' '}
                            <br />
                            Converted To:{' '}
