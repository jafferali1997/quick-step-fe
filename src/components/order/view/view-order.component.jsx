...
import OrderBlankPreview from '../create/view-blank-pdf/preview.component';
import OrderPreview from '../create/view-pdf/preview.component';
import useViewOrder from './use-view-order.hook';
import PreviewOrder from '../create/preview/preview-order.component';
            ...
            <div className="tw-w-full  ">
              <div className="tw-flex tw-items-center tw-justify-between">
                ...
                {data &&
                  data.length &&
                  data?.map((pdf) => {
                    return <OrderPreview orderId={pdf.id} />;
                  })}
              </div>
            </div>
          </Dialog>
            ...
            <div className="tw-w-full  ">
              <div className="tw-flex tw-items-center tw-justify-between">
                ...
                {data &&
                  data.length &&
                  data?.map((pdf) => {
                    return <OrderBlankPreview orderId={pdf.id} />;
                  })}
              </div>
            </div>
          </Dialog>
          ...
          <div className="tw-w-full  ">
            ...
            >
              {data &&
                data.length &&
                data?.map((pdf) => {
                  return <PreviewOrder orderId={pdf.id} />;
                })}
            </div>
            {singleOrder && singleOrder.data ? (
              <div>
