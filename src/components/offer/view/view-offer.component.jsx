...
import OfferPreview from '../create/view-pdf/preview.component';
import useViewOffer from './use-view-offer.hook';
import OfferBlankPreview from '../create/view-blank-pdf/preview.component';
            ...
            <div className="tw-w-full  ">
              <div className="tw-flex tw-items-center tw-justify-between">
                ...
                {data &&
                  data.length &&
                  data?.map((pdf) => {
                    return <OfferPreview offerId={pdf.id} />;
                  })}
              </div>
            </div>
          </Dialog>
            ...
            <div className="tw-w-full  ">
              <div className="tw-flex tw-items-center tw-justify-between">
                ...
                {data &&
                  data.length &&
                  data?.map((pdf) => {
                    return <OfferBlankPreview offerId={pdf.id} />;
                  })}
              </div>
            </div>
          </Dialog>
