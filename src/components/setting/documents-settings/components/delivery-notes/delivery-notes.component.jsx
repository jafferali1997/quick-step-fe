...
import { DELIVERY_NOTES_STATUS_OPTIONS } from '@/common/constants/document-status-options.constant';
import useDeliveryNotesSetting from './use-delivery-notes.hook';

export default function DeliveryNotesSetting() {
  const {
    register,
    handleSubmit,
    errors,
    ...
    <div className="tw-rounded-[10px] tw-bg-white tw-px-5 tw-py-8">
      ...
      <div className="tw-mt-6 tw-flex tw-flex-wrap tw-gap-[17px]">
        ...
        <div className="tw-flex tw-w-full tw-max-w-[347px] tw-flex-col tw-gap-2">
          ...
          <div className="tw-mt-2">
            <CustomInput
              name="deliveryNotesNumberPrefix"
              placeholder="Enter Delivery notes number prefix"
              type="text"
              isRequired={true}
              register={register}
              errors={errors}
        ...
        <div className="tw-flex tw-w-full tw-max-w-[347px] tw-flex-col tw-gap-2">
          ...
          <div className="tw-flex tw-items-start tw-rounded-lg tw-bg-[#e4e4e466] tw-p-2.5">
            ...
            <div className="tw-text-xs tw-font-normal tw-not-italic tw-leading-[20.5px] tw-text-text-medium-gray">
              The "Suffix" field complements the Delivery notes number by allowing you to
              append a customizable text
              <span className="tw-text-2xl tw-font-normal tw-not-italic tw-leading-[20.5px] tw-text-black">
                "
              </span>
            </div>{' '}
          ...
          <div className="tw-mt-2">
            <CustomInput
              name="deliveryNotesNumberSuffix"
              placeholder="Enter Delivery notes number suffix"
              type="text"
              isRequired={true}
              register={register}
              errors={errors}
      ...
      <div className="tw-mt-6 tw-flex tw-w-full tw-flex-col tw-gap-2">
        ...
        <div className="tw-flex tw-items-start tw-rounded-lg tw-bg-[#e4e4e466] tw-p-2.5">
          ...
          <div className="tw-text-xs tw-font-normal tw-not-italic tw-leading-[20.5px] tw-text-text-medium-gray">
            By setting an offset, you can begin your Delivery notes numbering sequence at
            a predetermined value, ensuring consistency, and alignment with your business
        ...
        <div className="tw-mt-2">
          <CustomInput
            name="deliveryNotesNumberOffset"
            placeholder="Enter Delivery notes number offset"
            type="text"
            isRequired={true}
            register={register}
            errors={errors}
      ...
      <div className="tw-mt-4 tw-flex tw-w-full tw-flex-col tw-gap-2">
        ...
        <div className="tw-flex tw-items-start tw-rounded-lg tw-bg-[#e4e4e466] tw-p-2.5">
          ...
          <div className="tw-text-xs tw-font-normal tw-not-italic tw-leading-[20.5px] tw-text-text-medium-gray">
            Whenever the Delivery notes document is booked, the email will be send to the
            entered email addresses with PDF of Delivery notes document
            <span className="tw-text-2xl tw-font-normal tw-not-italic tw-leading-[20.5px] tw-text-black">
              "
            </span>
          </div>{' '}
      ...
      <div className="tw-mt-6">
        ...
        <div className="tw-mt-4">
          <CustomRadioGroup
            ...
            options={DELIVERY_NOTES_STATUS_OPTIONS}
      ...
      <div className="tw-mt-6 tw-flex tw-w-full tw-justify-end">
        <CustomButton
          ...
          text="Save"
          onClick={handleSubmit(handleDeliveryNotesSettingSubmit)}
        />
      </div>
    </div>
  );
