...
import useDeliveryNotesDetail from './use-offer-detail.hook';

export default function DeliveryNotesDetail() {
  const {
    deliveryNotesId,
    data,
      ...
      <div className="tw-min-h-[100vh] tw-w-full tw-bg-[#FBFBFB] tw-px-[23px] ">
        <div className="tw-flex tw-items-center tw-justify-between tw-py-[24px]">
          <div className="tw-flex tw-items-center tw-gap-[16px]">
            <Link href="/delivery-notes/view">
              <img src="/assets/images/back-icon.svg" alt="img" />
            </Link>
            <h1 className="admin-top-heading ">Delivery Notes Details</h1>
            <p className="admin-top-p">Delivery Notes # {data?.displayId}</p>
          </div>
          <CustomButton
            href={`/deliveryNotes/edit?id=${deliveryNotesId}&d-id=${data?.displayId}`}
        ...
        <div className="2bars tw-flex tw-gap-[24px] xs:tw-flex-col-reverse xs:tw-flex-wrap lg:tw-flex-row lg:tw-flex-nowrap">
            ...
            <div className="form-box tw-w-full ">
              ...
              <div className="form-box-grid">
                ...
                <CustomInput
                  ...
                  type="text"
                  readOnly
                  defaultValue={data?.customer?.country}
                />
                <CustomInput
                  label="City"
                  name="City"
                  ...
                  type="text"
                  readOnly
                  defaultValue={data?.customer?.city}
                />
                <CustomInput
                  label="Postal Code"
                  name="Postal Code"
                  ...
                  type="text"
                  readOnly
                  defaultValue={data?.customer?.postalCode}
                />
                <CustomInput
                  label="Address"
                  name="Address"
                ...
                <CustomInput
                  ...
                  type="text"
                  readOnly
                  defaultValue={data?.customerCompanyAddress?.addressLabel}
                />
                <CustomInput
            ...
            <div className="form-box tw-mt-4 tw-w-full ">
              ...
              <div className="form-box-grid">
                <CustomInput
                  ...
                  type="text"
                  readOnly
                  defaultValue={data?.businessDetail?.businessName}
                />
                <CustomInput
                  ...
                  type="text"
                  readOnly
                  defaultValue={data?.businessDetail?.slogan}
                />
                <CustomInput
                  label="Date"
                  name="Date"
                  ...
                  type="text"
                  readOnly
                  defaultValue={data?.deliveryNotesDate}
                />
                <CustomInput
                  label="Company Email"
                  name="Company Email"
                  ...
                  type="text"
                  readOnly
                  defaultValue={data?.businessDetail?.businessEmail}
                />
                <CustomInput
                  ...
                  type="text"
                  readOnly
                  defaultValue={data?.businessDetail?.address}
                />
              ...
              <div className="tw-w-full">
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: data?.deliveryNotesBody?.bodyDescription
                  }}
                />
              </div>
            </div>
            <div className="form-box tw-mt-4 tw-w-full  ">
              ...
              <div className=" tw-mt-[15px] tw-flex tw-flex-row tw-items-start tw-justify-between tw-rounded-[20px] tw-bg-[#fafafa] tw-px-6 tw-py-4">
                ...
                <div className="tw-flex tw-flex-col tw-justify-between tw-gap-4 tw-text-right">
                  <div className="tw-text-base tw-font-medium tw-leading-[19px] tw-text-[#646464]">
                    € {lineItemNetAmount(data && data?.offerProducts)}
                  </div>
                  <div className="tw-text-base tw-font-medium tw-leading-[19px] tw-text-[#646464]">
                    € {taxRate(data && data?.offerProducts)}
                  </div>
                  <div className="tw-text-base tw-font-semibold tw-leading-[19px] tw-text-text-black">
                    €{' '}
                    {data && data.isVat
                      ? invoiceAmountWithVAT(data && data?.offerProducts)
                      : invoiceAmountWithOutVAT(data && data?.offerProducts)}
                  </div>
                </div>
              </div>
            </div>
            <div className="form-box tw-mt-4 tw-w-full ">
              ...
              <div className="tw-flex tw-w-full tw-flex-col tw-gap-[16px] tw-py-[16px]">
                ...
                <div
                  className="input-field default-input tw-min disabled-input !tw-h-fit tw-text-sm tw-font-normal tw-not-italic tw-leading-[17.5px] tw-text-text-dark-gray hover:tw-border-text-dark-gray focus:tw-border-[1px] focus:tw-border-text-dark-gray"
                  dangerouslySetInnerHTML={{
                    __html: data?.deliveryNotesDisclaimer?.disclaimerDescription
                  }}
                />
          ...
          <div className="right-side tw-h-fit lg:tw-sticky lg:tw-top-4">
            <div className="form-box tw-flex tw-h-[77px] tw-w-[336px] tw-items-center tw-justify-between ">
              ...
              <span
                className={`tw-rounded-[5px] tw-bg-[#DCFFDE] !tw-px-[8px] !tw-py-[4px] tw-text-[#0DA60A] ${getDeliveryNotesStatusClass(
                  data?.status
                )}`}
              >
                Delivered
            ...
            <div className="form-box  tw-mt-[16px] tw-w-[336px]  ">
              ...
              <div className=" tw-mt-[16px] tw-flex tw-flex-col tw-gap-[12px] ">
                {deliveryNotesAttachment.isLoading ? (
                  <CircularILoader />
                ) : (
                  deliveryNotesAttachment &&
                  deliveryNotesAttachment.data &&
                  deliveryNotesAttachment.data.attachments &&
                  deliveryNotesAttachment.data.attachments?.map(({ file }) => {
                    return (
                      <div
