          ...
          <form onSubmit={onSubmit}>
            ...
            <div>
                ...
                >
                  ...
                  >
                    <p className="tw-text-xs tw-font-medium tw-not-italic tw-leading-[18px] tw-text-text-black">
                      {(selectedDeliveryNotes && selectedDeliveryNotes?.bodyTitle) ||
                        'Default Text'}
                    </p>
                    {disclaimerOpen ? (
                      <svg
                      ...
                      {allBodyDeliveryNotes?.map((deliveryNotes) => {
                        return (
                          <div
                            ...
                            onClick={() => {
                              handleSelectedDeliveryNotes(deliveryNotes);
                      ...
                      <div className="tw-w-full">
                        <div className="tw-mb-[-20px] tw-flex tw-justify-between tw-text-[10px] tw-font-normal tw-leading-[15px]">
                          ...
                          <div className=" tw-text-[10px] tw-font-normal tw-leading-[15px] tw-text-text-medium-gray">
                            Max: {256 - ((bodyTitle && bodyTitle.length) || 0)}
                          </div>
                        </div>
                        <CustomInput
                          label="Title"
              ...
              <div className="tw-mt-4">
                {selectedDeliveryNotes?.bodyDescription ? (
                  <div
                    ...
                    dangerouslySetInnerHTML={{
                      __html: selectedDeliveryNotes?.bodyDescription
                    }}
                  />
                ) : (
            ...
            <StepperFooter
              ...
              disabled={!selectedDeliveryNotes || !deliveryDate}
            />
          </form>
        </div>
      </div>
