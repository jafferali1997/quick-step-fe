    ...
    <div className="tw-max-w-full tw-overflow-x-auto">
      ...
      <div className="tw-w-full tw-pb-5">
        <CustomDataTabe
          ...
          isTabTable={true}
          isOfferDraft={true}
          handleBookOffer={handleBookDeliveryNotes}
          isConvertShow={true}
          action={action}
          allData={allData}
          convertToOptions={convertToOptions}
          isBookDraft={true}
          handleBook={handleBookDeliveryNotes}
          ...
          <DialogContent>
            <div className="tw-w-full">
              <TextArea
                ...
                type="text"
                className="tw-h-[100px] tw-px-2 tw-py-[9.5px]"
                value={comment}
              ...
              <div className="tw-mt-6 tw-flex tw-justify-between tw-gap-[20px]">
                ...
                <div className="tw-flex tw-justify-end tw-gap-5">
                  <CustomButton
                    ...
                    text="Close"
                    className="tw-border tw-border-solid tw-border-text-ultra-light-gray tw-bg-[#CDCDCD] tw-px-4 tw-py-2 tw-text-sm tw-font-medium tw-leading-[17.5px] tw-text-text-medium-gray"
                  />
                  <CustomButton
