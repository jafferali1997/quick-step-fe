...
export default function OverviewContent({ action, allData }) {
  const {
    data,
    openPopup,
    setOpenPopup,
    ...
    setOpenQRPopUp,
    qrCodeImage
  } = useOverView({ action, allData });

  const initialColumns = [
    { id: '1', name: 'displayId', title: 'Delivery Notes #', selected: true },
  ...
  return (
    <div className="tw-max-w-full tw-overflow-x-auto">
      <ConfirmationModal
        show={openQRPopUp}
        close={setOpenQRPopUp}
        message="Scan QR Code"
        messageStyling="tw-mt-6 tw-text-xl tw-not-italic tw-font-bold tw-leading-[30px]"
        content="Scan this code to confirm the order"
        contentStyling="tw-mt-2 tw-text-sm tw-not-italic tw-font-normal tw-leading-[17.5px]"
        img="/assets/icons/qr-img.svg"
        crossImg="/assets/icons/gray-cross-img.svg"
        qrCode={true}
      ...
      <div className="tw-w-full tw-pb-5">
        <CustomDataTabe
          ...
          isTabTable={true}
          customStatusOptions={DELIVERY_NOTES_STATUS_OPTIONS}
      ...
      >
        <div className="tw-max-h-full tw-w-[480px] tw-max-w-full ">
          <div className="tw-flex tw-h-14 tw-items-center  tw-justify-between tw-bg-[#e3ecf4] tw-px-5">
            <div className=" tw-text-xl tw-font-medium tw-not-italic tw-leading-[30px] tw-text-text-dark-gray">
              Reason
            </div>
