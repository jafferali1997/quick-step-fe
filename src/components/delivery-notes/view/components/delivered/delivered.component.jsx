...
import useDelivered from './use-delivered.hook';
...
export default function DeliveredContent({ action, allData }) {
  const {
    columns,
    data,
    ids,
