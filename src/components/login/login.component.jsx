            ...
            <form className="tw-w-full" onSubmit={handleSubmit(onSubmit)} method="post">
              <div className="form-group-c tw-gap-[6px]">
                <label className="tw-text-sm tw-font-normal tw-leading-[18px]">
                  Email/Username <span className="tw-text-red-600">*</span>
                </label>
                <input
                  {...register('email')}
                  type="text"
              ...
              <div className="login-with-provider">
                ...
                >
                  <img
                    ...
                    className="tw-h-[18px] tw-w-[17.93px]"
                  />
                </button>
                <LoginWithLinkedIn />
              </div>
              <div className="tw-text-xs tw-font-normal tw-leading-[18px] tw-text-text-dark-gray">
                <p className="login tw-mt-[32px] tw-text-center">
                  Create an account?
