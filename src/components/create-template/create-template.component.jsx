      ...
      <div className="tw-flex tw-items-center tw-justify-between">
        <div className="tw-flex tw-items-center tw-gap-4 tw-pb-[16px] tw-pt-[24px]">
          ...
          <h1 className="tw-text-[22px] tw-font-medium tw-capitalize tw-not-italic tw-leading-[27.5px] tw-text-text-dark-gray">
            Create {docType && docType.toLowerCase()} Template
          </h1>
        </div>
      </div>
      <div className="tw-flex tw-gap-6">
        <div className="tw-w-full">
          <div className="tw-rounded-xl tw-border tw-border-solid tw-border-disabled-input tw-bg-white tw-px-5 tw-pb-[25.003px] tw-pt-5">
                                    ...
                                    >
                                      {(provided) => (
                                        <span
                                          ...
                                          {...provided.dragHandleProps}
                                          ref={provided.innerRef}
                                          className="rounded-t-lg tw-w-full tw-max-w-[85px] tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap tw-border-b tw-border-solid tw-border-b-[#E7EAEE] tw-bg-[#FAFAFA] tw-px-2 tw-py-4 tw-text-center tw-text-sm tw-font-normal tw-not-italic tw-leading-[18px] tw-text-text-black"
                                          onClick={(event) => {
            ...
            <div className="tw-mt-6 tw-flex tw-justify-between">
              <div />
              <CustomButton className="btn-primary" text="Save" onClick={handleSave} />
            </div>
            <div />
          </div>
        </div>
        {tempSettingOpen && (
          <div className="side-sticky tw-top-3 tw-h-fit tw-max-h-[400px]">
            <div className="tw-h-[568px] tw-w-[358px] tw-rounded-xl tw-border tw-border-solid tw-border-disabled-input tw-bg-white tw-px-5 tw-pr-2.5 tw-pt-4">
              ...
              {activeDiv === 'table header' && (
                <div className="tw-mt-6 tw-flex tw-flex-col tw-gap-[24px]">
                  ...
                  <Editor
                    onInit={(evt, editor) => (productsEditorRef.current = editor)}
