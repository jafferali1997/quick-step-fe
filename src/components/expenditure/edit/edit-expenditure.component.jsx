...
import useEditExpenditure from './use-edit-expenditure.hook';
...
export default function EditExpenditure() {
  ...
  useClickOutside([refDelete, refPayment], [setDeleteOpenPopup, setPaymentOpenPopup]);
    ...
    <div className="tw-mx-6 tw-mb-[43px] tw-mt-4  tw-rounded-[20px] tw-border tw-border-solid tw-border-disabled-input tw-bg-white tw-p-5">
      <div className="tw-flex tw-items-center tw-justify-between">
        ...
        <div className="tw-flex tw-items-center tw-gap-6">
          ...
          <CustomButton
            className="btn-secondary tw-h-10 tw-w-[105px] tw-px-10 tw-py-[11.5px]"
            text="pay"
            onClick={() => {
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="form-box-grid-2col tw-mt-4">
          ...
          <SelectWithModel
            ...
            onChange={(e, val) => handleSelectCategory(val)}
          />
          <CustomInput
            label="Cash Discount"
            name="cashDiscount"
          ...
          <div>
            ...
            {paymentError && (
              <FieldError
                ...
                error={'You are not allowed to decrease the expenditure payment amount'}
              />
            )}
          </div>
          <SelectWithModel
          ...
          />
          <CustomInput
            label={<span className="tw-normal-case">Date of Receipt</span>}
            name="receiptDate"
            register={register}
            control={control}
            errors={errors}
        ...
        <div className="tw-mt-4 tw-w-full">
          <div className="tw-flex tw-flex-col tw-gap-2">
            ...
            <div className="tw-relative tw-flex tw-min-h-[144px] tw-flex-col tw-items-center tw-justify-center tw-gap-4 tw-rounded-md tw-border-[1.5px] tw-border-dashed tw-border-text-ultra-light-gray tw-bg-[#FCFCFC] tw-px-4 tw-py-2">
              <input
        ...
        <div className="tw-mt-4 tw-flex tw-w-full tw-gap-4">
          <div className="tw-flex tw-h-[85px] tw-w-[85px] tw-items-center tw-justify-center tw-rounded-md tw-bg-[#fafafa] ">
            <img className="tw-w-full" src="/assets/images/upload-sample.png" alt="img" />
          </div>
          <div className="tw-flex tw-h-[85px] tw-w-[85px] tw-items-center tw-justify-center tw-rounded-md tw-bg-[#fafafa] ">
            <img className="tw-w-full" src="/assets/images/upload-sample.png" alt="img" />
          </div>
        ...
        <div className="tw-mt-[40px] tw-w-full tw-rounded-[10px] tw-bg-[#FBFBFB] tw-px-5 tw-py-4">
          ...
          {singleExpenditureData?.partialPayments[0]?.partialPayment && (
            <div className="tw-mt-3 tw-flex tw-items-center tw-justify-between">
              <p className="tw-text-sm tw-font-normal tw-not-italic tw-leading-[17.5px] tw-text-text-medium-gray">
                Partial Payment
              </p>
        ...
        <div className="tw-mt-6 tw-flex tw-w-full tw-items-center tw-justify-between">
          <CustomButton
            className="btn-danger "
            text="delete"
            onClick={() => setDeleteOpenPopup(true)}
          />
          <div className="tw-flex tw-items-center tw-gap-6">
          ...
          <DialogContent sx={{ padding: '0px 0px 0px 0px' }}>
            <div className="tw-flex tw-flex-col tw-items-center tw-rounded-[20px] tw-bg-white tw-px-6 tw-py-10">
              ...
              <h3 className=" tw-mt-6 tw-text-center tw-text-base tw-font-bold tw-not-italic tw-leading-6 tw-text-text-dark-gray">
                ...
                {singleExpenditureData?.companyName}
              </h3>
              ...
              <div className="tw-mt-[48px] tw-flex tw-justify-center tw-gap-8">
                ...
                <CustomButton
                  ...
                  onClick={() => handleDeleteExpenditure(singleExpenditureData?.id)}
                />
              </div>
            </div>
          </DialogContent>
          ...
          <DialogContent className="tw-rounded-xl">
            <form onSubmit={payExpenditurehandleSubmit(payExpenditureSubmit)}>
              ...
              <div className="tw-mt-6 tw-flex tw-w-full tw-flex-col tw-gap-4 tw-rounded-xl tw-bg-[#FBFBFB] tw-px-4 tw-pb-[24px] tw-pt-2">
                ...
                <div className=" tw-min-h-[1px] tw-w-full tw-bg-[#CFCFCF]"></div>
                <div className="tw-flex tw-items-center tw-justify-between">
        ...
        <div className="my-scroll tw-max-h-full  tw-max-w-full tw-overflow-y-auto ">
          <DialogContent sx={{ padding: '0px 0px 0px 0px' }}>
            <div className="tw-flex tw-flex-col tw-items-center tw-rounded-[20px] tw-bg-white tw-px-6 tw-py-10">
              ...
              <h3 className=" tw-mt-6 tw-text-center tw-text-base tw-font-bold tw-not-italic tw-leading-6 tw-text-text-dark-gray">
                Payment amount cannot be less than the balance amount
              </h3>

              <div className="tw-mt-[48px] tw-flex tw-justify-center tw-gap-8">
                <CustomButton
                  onClick={() => setPaymentOpenPopup(false)}
                  text="cancel"
                  className="btn-white-cancel tw-h-[40px] tw-w-[75px]"
                />
                <CustomButton
